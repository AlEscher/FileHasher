...
class SHA256Hasher final : public HashingAlgorithm
{
public:
...
private:
    std::array<uint32_t, 8> m_hPrime = { 0x6a09e667U,
                                0xbb67ae85U,
                                0x3c6ef372U,
                                0xa54ff53aU,
                                0x510e527fU,
    ...
    const std::array<uint32_t, 64> m_k = { 0x428a2f98U, 0x71374491U, 0xb5c0fbcfU, 0xe9b5dba5U, 0x3956c25bU, 0x59f111f1U, 0x923f82a4U, 0xab1c5ed5U,
