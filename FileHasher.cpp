...
int main(int argc, char** argv)
{
    ...
    while (true)
    {
        ...
        else if (input == "file")
        {
            ...
            * so this may vary depending on harddrive (NVMe SSD). Tested only once:
            * Size (using filesystem::file_size / 1000) and duration (using chrono::high_resolution_clock) :
            * - 14847574 KB     => 134895 ms
            * - 5186093 KB      => 45846 ms     (for this example, 27.9s were spent with File IO, and 17.9s with hashing)
            * - 1039630 KB      => 9304 ms
            * - 431357 KB       => 3820 ms
            * - 103972 KB       => 928 ms
            * - 1245 KB         => 11 ms
            ...
            */
            ...
            std::string hash = sha256Hasher->CalculateHash(L"C:/Dev/Cpp/FileHasher/test", fileSize);
            auto end = std::chrono::high_resolution_clock::now();
            std::cout << "File SHA256: " << hash << std::endl;
